...
@ToString
@EqualsAndHashCode
@Schema(description = "ShiftEditRequestsResponse DTO")
public class GetShiftEditRequestsResponse {
    ...
    @Singular
    @Schema(description = "List of shift edit requests")
    private List<ShiftEditRequest> shiftEditRequests;

    @Schema(description = "Total number of shift edit requests")
