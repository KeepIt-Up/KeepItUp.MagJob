...
/// </remarks>
public class GetUserOrganizationsEndpoint(IMediator mediator, ICurrentUserAccessor currentUserAccessor)
    : Endpoint<GetUserOrganizationsRequest, GetUserOrganizationsResponse>
{
    ...
    public override async Task HandleAsync(GetUserOrganizationsRequest req, CancellationToken ct)
    {
        ...
        {
            Organizations = result.Value.Select(o => new OrganizationDto
            {
                Id = o.Id,
                Name = o.Name,
