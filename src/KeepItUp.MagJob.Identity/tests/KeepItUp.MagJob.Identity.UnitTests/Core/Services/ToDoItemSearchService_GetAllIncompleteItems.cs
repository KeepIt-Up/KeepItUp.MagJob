...
using KeepItUp.MagJob.Identity.Core.ProjectAggregate;
using KeepItUp.MagJob.Identity.Core.Services;
using KeepItUp.MagJob.Identity.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace KeepItUp.MagJob.Identity.UnitTests.Core.Services
{
