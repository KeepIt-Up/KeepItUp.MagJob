package com.keepitup.workevidence.api.WorkEvidence.API.configuration;

import com.keepitup.workevidence.api.WorkEvidence.API.jwt.CustomJwt;
import com.keepitup.workevidence.api.WorkEvidence.API.jwt.CustomJwtConverter;
...
public class SecurityConfig {
  ...
  private static final AntPathRequestMatcher[] authenticatedList = {
    ...
    new AntPathRequestMatcher("/api/workevidence/shifts/{id}")
  };
